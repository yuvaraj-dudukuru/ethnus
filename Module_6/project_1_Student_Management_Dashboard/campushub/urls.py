...
from students.api_views import StudentViewSet, DepartmentViewSet, LogoutAPI
...
urlpatterns = [
    ...
    # TemplateView is the simplest possible view: it just renders a template,
    # with no extra Python logic. All the live behaviour (loading students,
    # search, add, edit, delete) is done by JavaScript talking to the API below.
