...
class PostListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        # 'likes' (added in M6) is included so each card in the feed can show
        # and animate its heart count without a second request.
        fields = ['id', 'title', 'slug', 'author_name',
                  'category_name', 'status', 'likes', 'created']
