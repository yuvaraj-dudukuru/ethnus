# ============================================================================
#  settings.py — master configuration for LearnSpace LMS.
# ----------------------------------------------------------------------------
...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-learnspace-learning-key-change-me"
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "learnspace.pagination.StandardPagination",
