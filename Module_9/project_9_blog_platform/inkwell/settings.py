# ============================================================================
#  settings.py — master configuration for Inkwell Blog.
# ----------------------------------------------------------------------------
...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-inkwell-learning-key-change-me"
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "inkwell.pagination.StandardPagination",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Posts, comments and like toggles with author-only edit.",
    "VERSION": "1.0.0",
