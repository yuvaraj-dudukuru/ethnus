# ============================================================================
#  settings.py — master configuration for ShopCart Store.
# ----------------------------------------------------------------------------
...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-shopcart-learning-key-change-me"
)
...
# User-uploaded files (images, resumes). In production these belong on S3.
MEDIA_URL = "media/"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "shopcart.pagination.StandardPagination",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Products, cart and transactional checkout with price snapshots.",
    "VERSION": "1.0.0",
