# ============================================================================
#  settings.py — master configuration for MediCare Hospital.
# ----------------------------------------------------------------------------
...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-medicare-learning-key-change-me"
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "medicare.pagination.StandardPagination",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Doctors, patients, appointments and medical records (RBAC).",
    "VERSION": "1.0.0",
