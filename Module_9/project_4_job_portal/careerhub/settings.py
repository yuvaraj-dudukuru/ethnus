# ============================================================================
#  settings.py — master configuration for CareerHub Job Portal.
# ----------------------------------------------------------------------------
...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-careerhub-learning-key-change-me"
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "careerhub.pagination.StandardPagination",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Recruiters post jobs; candidates apply with resumes.",
    "VERSION": "1.0.0",
