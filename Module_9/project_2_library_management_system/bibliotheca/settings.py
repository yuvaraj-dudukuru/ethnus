# ============================================================================
#  settings.py — master configuration for Bibliotheca Library.
# ----------------------------------------------------------------------------
...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-bibliotheca-learning-key-change-me"
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "bibliotheca.pagination.StandardPagination",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Books, members and issue/return with due dates and fines.",
    "VERSION": "1.0.0",
