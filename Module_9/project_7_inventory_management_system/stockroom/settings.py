# ============================================================================
#  settings.py — master configuration for StockRoom Inventory.
# ----------------------------------------------------------------------------
...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-stockroom-learning-key-change-me"
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "stockroom.pagination.StandardPagination",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Products, suppliers and atomic stock movements with low-stock alerts.",
    "VERSION": "1.0.0",
